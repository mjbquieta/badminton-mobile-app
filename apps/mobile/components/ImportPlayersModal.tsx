			...
			>
				...
				>
					...
					<ScrollView className="p-4" keyboardShouldPersistTaps="handled">
						{/* Format hints */}
						<View className="bg-dark-200 border border-dark-100 rounded-xl p-3 mb-3">
							<Text
						...
						{/* Error */}
						{error && (
							<View className="bg-red-500/10 border border-red-500/30 rounded-xl p-3 mb-3 flex-row items-center">
								<AntDesign
						...
						<TextInput
							...
							className="bg-dark-200 border border-dark-100 rounded-xl px-3 py-3 text-sm min-h-[160px]"
							style={{ color: BadmintonPalette.text.primary }}
						/>
					</ScrollView>
